...
var hikeEvents = __webpack_require__(16);
...
var onSignOut = function onSignOut(event) {
  ...
  api.signOut().then(ui.signOutSuccess).catch(ui.signInFailure);
};
...
var onCreateHike = function onCreateHike(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // console.log(data)
  api.createHike(data).then(ui.createHikeSuccess).then(getHikesUpdate).catch(ui.createHikeFailure);
};

var onGetAllHikes = function onGetAllHikes(event) {
  event.preventDefault();
  // console.log(event)
  api.getHikes().then(ui.getHikesSuccess)
  // had to do the below so that all of these run before my handlebars since the button functionality relies on the below
  .then(function () {
    return $('.update-hike-form').on('submit', onUpdateHike);
  }).then(function () {
    return $('.delete-hike-link').on('click', onDeleteHike);
  }).catch(ui.getHikesFailure);
};

// function to get hikes again once a hike is updated or created
var getHikesUpdate = function getHikesUpdate(event) {
  api.getHikes().then(ui.getHikesSuccess)
  // had to do the below so that all of these run before my handlebars since the button functionality relies on the below
  .then(function () {
    return $('.update-hike-form').on('submit', onUpdateHike);
...
var onDeleteHike = function onDeleteHike(event) {
  event.preventDefault();
  // console.log('delete hike clicked')
  // have to get the hike ID that I want to delete
  var hikeId = $(event.target).data('id');
  // console.log(hikeId)
  api.deleteHike(hikeId).then(ui.deleteHikeSuccess(hikeId)).then(getHikesUpdate).catch(ui.deleteHikeFailure);
};

var onUpdateHike = function onUpdateHike(event) {
  event.preventDefault();
  // console.log('update modal button clicked')
  var hikeId = $(event.target).data('id');
  // console.log('hike updating is', hikeId)
  var updateHike = getFormFields(event.target);
  // console.log('updated info:', updateHike)
  api.updateHike(updateHike, hikeId).then(ui.updateHikeSuccess(hikeId)).then(getHikesUpdate).catch(ui.updateHikeFailure);
};
...
var createHike = function createHike(data) {
  // console.log(data)
  return $.ajax({
...
var updateHike = function updateHike(data, hikeId) {
  return $.ajax({
...
var deleteHike = function deleteHike(hikeId) {
...
var showHikesTemplate = __webpack_require__(19);

var createHikeSuccess = function createHikeSuccess(data) {
...
var createHikeFailure = function createHikeFailure() {
...
var getHikesFailure = function getHikesFailure() {
  // console.log('Failed to get all hikes')
};

var deleteHikeSuccess = function deleteHikeSuccess(id) {
  // console.log('Successfully deleted a hike')
  // $("div[data-id='" + id + "']").remove()
  // show message that you succssfully deleted name of hike
};

var deleteHikeFailure = function deleteHikeFailure() {
  // console.log('Failed to delete hike')
};

var updateHikeSuccess = function updateHikeSuccess(data) {
...
var updateHikeFailure = function updateHikeFailure() {
  // console.log('Failed to update')
  $('.update-hike-modal-title').text('Something is wrong, please close try again.');
};

module.exports = {
  createHikeSuccess: createHikeSuccess,
  createHikeFailure: createHikeFailure,
  getHikesSuccess: getHikesSuccess,
  getHikesFailure: getHikesFailure,
  deleteHikeSuccess: deleteHikeSuccess,
  deleteHikeFailure: deleteHikeFailure,
  updateHikeSuccess: updateHikeSuccess,
  updateHikeFailure: updateHikeFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <table class=\"table table-hover\">\n      <tr>\n        <th>Date</th>\n        <th>Hike Name</th>\n        <th>City</th>\n        <th>State</th>\n        <th>Elevation gain</th>\n        <th>Miles roundtrip</th>\n        <th>Difficulty</th>\n        <th>Rating</th>\n        <th>Notes</th>\n        <th>Actions</th>\n      </tr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.hikes : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "      <tr>\n        <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hike_date : stack1), depth0))
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hike_name : stack1), depth0))
    + "</td>\n        <td>"
    ...
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.elevation_gain : stack1), depth0))
    + "</td>\n        <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.miles_rt : stack1), depth0))
    + "</td>\n        <td>"
    ...
    + "</td>\n        <!-- link to update and delete each hike in the last column -->\n        <td>\n          <a class=\"update-hike-link\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" href=\"#update-hike-modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-toggle=\"modal\">Update</a><br>\n          <a class=\"delete-hike-link\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" href=\"#\">Delete</a>\n        </td>\n      </tr>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "      <p>Oh no, you don't have any hikes yet - create one to get started!</p>\n";
},"6":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "  <div class=\"modal fade\" id=\"update-hike-modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\"  aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n               <span aria-hidden=\"true\">&times;</span>\n             </button>\n          <h5 class=\"update-hike-modal-title\">Input the fields you would like to update</h5>\n        </div>\n        <div class=\"update-modal-body\">\n          <form class=\"update-hike-form\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <label>Date of hike: <input name=\"hike[hike_date]\" type=\"date\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hike_date : stack1), depth0))
    + "\"></label><br>\n            <label>Hike name: <input name=\"hike[hike_name]\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.hike_name : stack1), depth0))
    + "\"></label><br>\n            <label>City: <input name=\"hike[city]\" type=\"text\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.city : stack1), depth0))
    + "></label><br>\n            <label>State: <input name=\"hike[state]\" type=\"text\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.state : stack1), depth0))
    + "></label><br>\n            <label>Elevation gain: <input name=\"hike[elevation_gain]\" type=\"text\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.elevation_gain : stack1), depth0))
    + "></label><br>\n            <label>Miles roundtrip: <input name=\"hike[miles_rt]\" type=\"text\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.miles_rt : stack1), depth0))
    + "></label><br>\n            <label>Difficullty: <input name=\"hike[difficulty]\" type=\"number\" min=\"1\" max=\"5\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.difficulty : stack1), depth0))
    + "></label><br>\n            <label>Rating: <input name=\"hike[rating]\" type=\"number\" min=\"1\" max=\"5\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
    + "></label><br>\n            <label>Notes: <textarea name=\"hike[notes]\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "></textarea></label>\n            <div class=\"modal-footer\">\n              <button class=\"update-button btn btn-primary\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update</button>\n              <button class=\"btn btn-secondary\" data-dismiss=\"modal\">Cancel</button>\n              <button type=\"reset\" class=\"btn btn-secondary\">Reset</button>\n            </div>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.hikes : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </table>\n\n  <!-- modal to update hike once link is clicked -->\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.hikes : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
